function [A,bv,xnodes,uh,Peh] = difftrasp(mu, eta, a, b, alpha, beta, fun,N)
...
% discretizzazione alle differenze finite centrate sia per la derivata
% prima sia per la derivata seconda
%
...
A = (mu / h^2) * A;
A=A+(eta/(2*h))*(sparse(2:N,1:N-1,-1,N,N)+sparse(1:N-1,2:N,+1,N,N));
