function [A,bv,xnodes,uh] = dtrmixdx(mu, eta, sigma, a, b, alpha, gamma, fun,N)
% DTRMIXDX: la funzione che risolve il problema ai limiti di
...
%         { mu*u'(b) = gamma
%
% dove la derivata prima u'(b) è approssimata con differenze finite
% all'indietro (schema accurato di ordine 1).
