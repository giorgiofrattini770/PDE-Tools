function [A,bv,xnodes,uh] = dtrmixsxord2(mu, eta, sigma, a, b, delta, beta, fun,N)
% DTRMIXSXORD2: la funzione che risolve il problema ai limiti di
...
%         { u(b) = beta
%
% dove la derivata prima u'(a) è approssimata con uno schema decentrato per
